  ...
  return (
    <PageWrapper>
      ...
      <Stack maxWidth={"600px"} mt={4} padding={6}>
        ...
        <Typography mt={1}>
          <b>Hotel Brosundet:</b> Booking gjøres via linken under innen 20.
          juli.{" "}
        </Typography>
        ...
        <Typography mt={1}>
          <b>Quality Hotel Waterfront:</b> Booking gjøres via linken under innen
          27. juni.{" "}
        </Typography>
      ...
      <FullWidthStack>
        <DifferentTransport header="Buss til og fra bryllupet">
          Vi setter opp to busser som kjører fra Rutebilstasjonen i Ålesund
          sentrum til Giske Kirke før seremonien, buss mellom Gikse Kirke og
          Øygardshallen og nattbuss fra Øygardshallen til Rutebilstasjonen i
          Ålesund sentrum.
          <br />
          Detaljert info finner dere i programmet under fanen Lørdag.
        </DifferentTransport>
